# Welcome 👀
trend • 18 years old • retired developer

Im probably around here on then in github, haven't done anything too serious since 2022-2023. passionate on **web development** backend, networking.

## Skills

#### Coding Languages:
![Lua](https://img.shields.io/badge/Lua-Good-blue)
![JavaScript](https://img.shields.io/badge/JavaScript-Good-yellow)
![Python](https://img.shields.io/badge/Python-Good-blue)
